...
In the [Speiser orbit](@ref speiser-verification) section, we demonstrate how to use the hybrid equations scheme ([`hybridgcafo!`](@ref eom-api)) to switch from from the guiding centre equations to the Lorentz force in regimes like these.
